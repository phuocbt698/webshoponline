...
@section('contents')
                ...
                <div class="row d-flex justify-content-between">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form id="adminForm" method="POST" action="{{ route('admin.update', $user->id) }}"
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <select id="role" name="role" class="form-control">
                                            ...
                                            @foreach ($roles as $role)
                                                <option {{ $role->id == $user->id_role ? 'selected' : '' }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img id="imageOld" src="{{ asset($user->path_image) }}" alt=""
                                            width='100%'>
                                        <div id="preview">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="city" name="city" class="form-control">
                                                    <option class="option-city" value="0">--Tỉnh/Thành phố--</option>
                                                    @foreach ($cities as $city)
                                                        <option class="option-city"
                                                            {{ $city->id == $user->id_city ? 'selected' : '' }}
    ...
    <script>
        $(document).ready(function() {
            getFullAddress('{{ route('getDistrict') }}', {{ $user->id_district }}, '{{ route('getWard') }}',
                {{ $user->id_ward }});
            ...
            $('#adminForm').submit(function() {
                ...
                var errors = getAjax("{{ route('admin.update', $user->id) }}", formData, 'put');
                if (errors) {
