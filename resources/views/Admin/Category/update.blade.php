        ...
        <div class="row d-flex justify-content-between">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="categoryForm" method="POST" action="{{route('category.update', $category->id)}}" onsubmit="return false;">
                @csrf
                @method('put')
                <div class="card-body">
                  <div class="form-group">
                    <label for="name">Name</label>
                    <input value="{{$category->name}}" name="name" type="text" class="form-control" id="name" placeholder="Enter name">
  ...
  <script>
        $(document).ready(function(){
            $('#categoryForm').submit(function(){
                ...
                var errors = getAjax("{{route('category.update', $category->id)}}", data, 'put');
                if(errors){
